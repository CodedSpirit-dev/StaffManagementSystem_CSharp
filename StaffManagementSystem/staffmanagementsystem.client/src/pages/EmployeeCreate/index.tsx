...
const EmployeeForm = ({
  ...
  initialData: IEmployeeData | null;
}) => {
    ...
    if (initialData) {
      for (const [key, value] of Object.entries(initialData)) {
        if (key === "employmentDetails" && value.hiringDate) {
          setValue(
            "employmentDetails.hiringDate",
            value.hiringDate.split("T")[0]
  ...
  const onSubmit = (data: IEmployeeData) => {
    const formattedData = {
      ...data,
      birthDate: new Date(data.birthDate as unknown as string)
        .toISOString()
        .split("T")[0],
      employmentDetails: {
        ...data.employmentDetails,
        hiringDate: new Date(data.employmentDetails.hiringDate).toISOString(),
        resignationDate: data.employmentDetails.resignationDate
          ? new Date(data.employmentDetails.resignationDate).toISOString()
          : null,
        isFileComplete: JSON.parse(
          String(data.employmentDetails.isFileComplete)
        ),
        isActive: true,
    ...
    if (initialData) {
      axios
        .patch(
          `api/Employees/${formattedData.socialSecurityNumber}`,
          formattedData
        )
        .then(() => {
      ...
      axios
        .post("/api/Employees/", formattedData)
        .then(() => {
          window.location.href = "/lista";
        })
        .catch((error) => {
      ...
      >
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="input_text"
                {...register("lastName", {
                  required: "No olvides el apellido",
                })}
              />
              {errors.lastName && (
            ...
            <div>
              ...
              <input
                ...
                defaultValue={0}
                {...register("children", {
                  required: "El número de hijos no debe estar vacío",
                  min: { value: 0, message: "El número mínimo es 0" },
                  max: { value: 20, message: "El número máximo es 20" },
                })}
              />
              {errors.children && (
            ...
            <div>
              ...
              <select
                ...
                className="input_text"
                {...register("studyGrade", {
                  required: "El ultimo grado de estudios es requerido",
                })}
              >
            ...
            <div>
              ...
              <input
                ...
                {...register("socialSecurityNumber", {
                  required: "Por favor, introduce un número de seguro social.",
                })}
              />
            ...
            <div>
              ...
              <input
                ...
                className="input_text"
                {...register("rfc", {
                  required: "Por favor, introduce un RFC.",
                })}
              />
              {errors.rfc && (
                <p className="error-message">{errors.rfc.message}</p>
              )}
            </div>
            <div>
              ...
              <input
                ...
                className="input_text"
                {...register("curp", {
                  required: "Por favor, introduce un CURP.",
                })}
              />
              {errors.curp && (
                <p className="error-message">{errors.curp.message}</p>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="contactInfo.phoneNumber">
                Número de teléfono
              </label>
              <input
                type="tel"
            ...
            <div>
              ...
              <input
                ...
                {...register("address.street", {
                  required: "Por favor, introduce una calle.",
                })}
              />
            ...
            <div>
              ...
              <input
                ...
                {...register("address.number", {
                  required: "Por favor, introduce un número.",
                })}
              />
              {errors.address?.number && (
                <p className="error-message">{errors.address.number.message}</p>
              )}
            </div>
            <div>
              ...
              <input
                ...
                {...register("address.neighborhood", {
                  required: "Por favor, introduce una colonia.",
                })}
              />
            ...
            <div>
              ...
              <input
                ...
                {...register("address.state", {
                  required: "Por favor, introduce un estado.",
                })}
              />
            ...
            <div>
              ...
              <input
                ...
                {...register("address.postalCode", {
                  required: "Por favor, introduce un código postal.",
                })}
              />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="input_text"
                {...register("emergencyContact.emergencyContactName", {
                  required: "Por favor, introduce un nombre completo.",
                })}
              />
              {errors.emergencyContact?.emergencyContactName && (
                <p className="error-message">
                  {errors.emergencyContact.emergencyContactName.message}
                </p>
              )}
            </div>
            <div>
              ...
              <input
                ...
                className="input_text"
                {...register("emergencyContact.emergencyRelationship", {
                  required: "Por favor, introduce una relación.",
                })}
              />
              {errors.emergencyContact?.emergencyRelationship && (
                <p className="error-message">
                  {errors.emergencyContact.emergencyRelationship.message}
                </p>
              )}
            </div>
            <div>
              ...
              <input
                ...
                className="input_text"
                {...register("emergencyContact.emergencyPhone", {
                  required: "Por favor, introduce un número de teléfono.",
                })}
              />
              {errors.emergencyContact?.emergencyPhone && (
                <p className="error-message">
                  {errors.emergencyContact.emergencyPhone.message}
                </p>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="employmentDetails.jobTitle">
                Título del trabajo
              </label>
              <input
                type="text"
                ...
                {...register("employmentDetails.position", {
                  required: "Por favor, introduce un título de trabajo.",
                })}
              />
              {errors.employmentDetails?.position && (
                <p className="error-message">
                  {errors.employmentDetails.position.message}
                </p>
              )}
            </div>
            <div>
              ...
              {errors.employmentDetails?.department && (
                <p className="error-message">
                  {errors.employmentDetails.department.message}
                </p>
              )}
            </div>
            <div>
              <label htmlFor="employmentDetails.hiringDate">
              ...
              <input
                ...
                className="input_date"
                {...register("employmentDetails.hiringDate", {
                  required: "Por favor, introduce una fecha de contratación.",
                })}
              />
              {errors.employmentDetails?.hiringDate && (
                <p className="error-message">
                  {errors.employmentDetails.hiringDate.message}
                </p>
              )}
            </div>
            <div>
              <label htmlFor="employmentDetails.resignationDate">
                Fecha de renuncia
              </label>
              <input
                type="date"
            ...
            <div>
              <label htmlFor="employmentDetails.isFileComplete">
                ¿El expediente está completo?
              </label>
              <select
                id="employmentDetails.isFileComplete"
                className="input_text"
                {...register("employmentDetails.isFileComplete", {
              ...
              {errors.employmentDetails?.isFileComplete && (
                <p className="error-message">
                  {errors.employmentDetails.isFileComplete.message}
                </p>
              )}
            </div>
          </div>
        </div>
        <button type="submit" className="button_blue mt-4">
          Enviar
        </button>
      </form>
    </FormProvider>
